...
$database = "ihris";
$connect = mysqli_connect($host, $usernameDb, $password, $database);
...
class Employee_data extends mysqli
{
	...
	{
		$main_Arr = [];
		$sql = "SELECT * from spms_corefunctions where parent_id='' and mfo_periodId='$this->per_ID' ORDER BY `spms_corefunctions`.`cf_count` ASC";
		$sql = mysqli::query($sql);
		$parent = [[],[],[]];
...
-->
	...
	public function tableFooter()
	{
		...
		$overallAv = $this->strategic_totalAv+$this->core_totalAv+$this->support_totalAv;

...
<div id="rsm-header" style="display:none; margin-bottom: 0px; padding: 10px; background-color: #f8f9fa; text-align: center;">
	<div style="font-size: 24px; margin-bottom: 10px;">Rating Scale Matrix</div>
	<div id="rsm-department-title" style="margin: 0 0 5px 0; color: #333; font-size: 24px; font-weight: bold;"></div>
